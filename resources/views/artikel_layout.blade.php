    ...
    <div class="flex-1 flex">
        ...
        @auth
            @if (auth()->user()->is_admin)
                <aside class="hidden lg:block w-64 flex-shrink-0 border-r" style="background-color: var(--bg-surface); border-color: var(--border);">
                    <div class="flex flex-col h-full">
                        ...
                        <div class="p-4 border-b" style="border-color: var(--border);">
                            ...
                            <p class="mt-1 text-xs font-mono" style="color: var(--text-muted);">Quick Access</p>
                        </div>

                        <!-- Navigation Links -->
                        <nav class="flex-1 p-3 space-y-1 overflow-y-auto">
                            <a href="{{ route('admin.dashboard') }}"
                               class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors hover:bg-opacity-10"
