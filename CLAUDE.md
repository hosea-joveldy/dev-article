...
**YOU ARE IN: `dev_article/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/dev_article/` (rig root) or other directories
...
**Your mail address:** `dev_article/polecats/obsidian`
**Your rig:** dev_article
**Your Witness:** `dev_article/witness`
...
| Ask Witness for help | `gt mail send dev_article/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`dev_article/witness`) when:
...
```bash
gt mail send dev_article/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
